...
--
-- Entradas: 
--   - Dos operandos de 3 d�gitos BCD (12 bits cada uno: centenas, decenas, unidades).
...
--
-- Funcionamiento:
-- Usamos la t�cnica de "desplazamiento y suma" para multiplicar 
-- las centenas por 100 y las decenas por 10. Despu�s, si el n�mero es negativo, 
...
begin
    ...
    mag1 <= ("0"       & op1_bcd(11 downto 8) & "000000")    -- centenas � 64 : desplazamos 6 posiciones a la izquierda
          ...
          + ("000000"  & op1_bcd(7 downto 4)  & "0"     )    -- decenas � 2   : desplazamos 1 posici�n a la izquierda
    ...
    mag2 <= ("0"       & op2_bcd(11 downto 8) & "000000")    -- centenas � 64 : desplazamos 6 posiciones a la izquierda
          ...
          + ("000000"  & op2_bcd(7 downto 4)  & "0"     )    -- decenas � 2   : desplazamos 1 posici�n a la izquierda
